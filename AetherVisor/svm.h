...
typedef struct VmcbSaveStateArea
{
    ...
    uint64_t last_excep_to;               // +0x290 Why isnt this in VMCB layout table?
    uint64_t guest_debug_extnctl;         // +0x298

    uint8_t reserved7[0x670 - 0x2A0];     // +0x2A0
